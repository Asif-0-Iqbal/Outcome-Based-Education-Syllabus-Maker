...
const WeeklyPlanCard = ({ que, ExamYear , Regular_Short , Section , NO_123 , NO_ABC , Question , ConnectedCLO , Bloom_Taxonomy , showbuttons, queid, link }) => {
    const handleDelete = (id) => {
        if (confirm('Are you sure you want to delete this Question?')) {
            router.delete(route('deleteWeeklyLessonPlan', { queno: id }));
        }
    };
